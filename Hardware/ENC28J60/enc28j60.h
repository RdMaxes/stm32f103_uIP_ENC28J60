...
#define ENC28J60_RST_PIN			GPIO_Pin_12
#define ENC28J60_RST_SET();			GPIO_SetBits( ENC28J60_CS_PORT, ENC28J60_CS_PIN );  
#define ENC28J60_RST_CLEAR();		GPIO_ResetBits( ENC28J60_CS_PORT, ENC28J60_CS_PIN );
